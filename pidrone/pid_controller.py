...
class PIDController(object):
    ...
    def __init__(self):
        ...
        self.lr_pid = PIDaxis(kp=10.0, ki=5.0, kd=10.0, midpoint=0, control_range=(-10.0, 10.0))
        # front/back (pitch) pid
        # MS Was
        # self.fb_pid = PIDaxis(kp=20.0, ki=5.0, kd=10.0, midpoint=0, control_range=(-10.0, 10.0))
        self.fb_pid = PIDaxis(kp=10.0, ki=5.0, kd=10.0, midpoint=0, control_range=(-10.0, 10.0))
    ...
    def desired_pose_callback(self, msg):
        ...
        if self.desired_position != self.last_desired_position:
            ...
            self.moving = True
            print 'moving'
        print "Desired pose set: ",self.desired_position
    ...
    def reset_callback(self, empty):
        ...
        print "Reset Called, desired position: ",self.desired_position
